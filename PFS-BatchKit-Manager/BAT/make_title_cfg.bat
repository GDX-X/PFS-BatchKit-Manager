...
"%~dp0BAT\busybox" sed -i "s/$/\"/" "%~dp0APPS\Foldertmp2.txt"
"%~dp0BAT\busybox" sed -i "s/^/\"/" "%~dp0APPS\Foldertmp2.txt"

"%~dp0BAT\busybox" sed -i "s/$/\"/" "%~dp0APPS\Foldertmp3.txt"
"%~dp0BAT\busybox" sed -i "s/^/\"/" "%~dp0APPS\Foldertmp3.txt"
...
"%~dp0BAT\busybox" sed -i "s/$/\"/" "%~dp0APPS\elf.txt"
"%~dp0BAT\busybox" sed -i "s/^/\"/" "%~dp0APPS\elf.txt"

"%~dp0BAT\busybox" sed -i "s/$/\"/" "%~dp0APPS\elftmp3.txt"
"%~dp0BAT\busybox" sed -i "s/^/\"/" "%~dp0APPS\elftmp3.txt"
