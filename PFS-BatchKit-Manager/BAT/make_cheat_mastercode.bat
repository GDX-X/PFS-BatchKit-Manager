...
Echo "!fname! /VER !GAMEVER! /ID !gameidelf!" | "%~dp0BAT\busybox" iconv -f windows-1252 -t utf-8 > "%~dp0CHT\!gameidelf!.cht"
...
"%~dp0BAT\busybox" sed -e "1i \"!fname! /VER !GAMEVER! /ID !gameidelf!\" " "%~dp0CHT\!gameidelf!.TMP" | "%~dp0BAT\busybox" iconv -f windows-1252 -t utf-8 > "%~dp0CHT\!gameidelf!.cht"
